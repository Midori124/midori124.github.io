...
monogatari.script ({
	...
	'Dont' : [
		...
		'Người đàn ông như cảm thấy tìm lại được một phần ký ức đã mất.',
		'Một buổi tối nọ...',
	...
	'Told' : [
		...
		'Người đàn ông như cảm thấy tìm lại được một phần ký ức đã mất.',
		'Một buổi tối nọ...',
		'Anh quyết định làm sáng tỏ mọi chuyện.',
		'show scene yuusoft2 with fadeIn',
		'y "Humm..."',
		'y "Bảo không shock thì cũng không đúng."',
		'y "Nhưng em hiểu được mà."',
	...
	'NotTold': [
		...
		'Kể từ ngày hôm đó.',
		'Tối nào cậu trai ấy cũng đến nhà anh.',
		'Cả hai cùng ăn tối và kể chuyện quá khứ.',
		'show scene yuusoft2 with fadeIn',
		'y "Humm..."',
		'y "Bảo không shock thì cũng không đúng."',
		'y "Nhưng em hiểu được mà."',
	...
	'Past' : [
		...
		// 'play music theme',
		'y "Anh không lừa em chứ..."',
		'y "Anh nhớ lại mọi chuyện rồi sao?"',
		'show scene yuusoft2 with fadeIn',
		'y "Tốt quá rồi... Cảm ơn anh."',
		'y "Em hạnh phúc lắm."',
		// 'stop music theme',
		'show scene #fffff with fadeIn',
		...
		's <span class="redText">Cậu ấy cứ mãi mắc kẹt trong quá khứ.',
		's <span class="redText">Thậm chí có những chuyện tôi còn không biết.',
		's <span class="redText">Tôi hoài nghi liệu mình có thực sự là Miyamura Sora?',
		's <span class="redText">Cậu ta rốt cuộc có phải người yêu tôi hay không?',
		's <span class="redText">Không... Không... Không... Không... Không... Không... Không... Không... Không... ',
		's <span class="redText">Tôi dần trở nên loạn trí...',
		's <span class="redText">Tôi không thể kiểm soát bản thân mình nữa rồi...',
